...
import example.com.authservice.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationManager authenticationManager(AuthenticationConfiguration authenticationConfigure) throws Exception{
